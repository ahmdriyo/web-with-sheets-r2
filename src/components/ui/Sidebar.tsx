...
const menuItems: MenuItem[] = [
  ...
  {
    label: "Categories",
    href: "/admin-showroom/categories",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  {
    label: "Site Settings",
    href: "/admin-showroom/site-settings",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
