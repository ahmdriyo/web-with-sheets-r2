...
export const SkeletonAbout = () => {
  return (
    <div className="min-h-screen bg-background animate-pulse">
      ...
      <Section className="bg-card">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
            {/* Mission skeleton */}
            <div className="p-4 md:p-8 rounded-2xl bg-muted border border-border">
              <div className="space-y-4">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-accent rounded-lg"></div>
                <div className="h-6 md:h-8 bg-accent rounded-lg w-2/3"></div>
      ...
      {/* Statistics Skeleton */}
      <Section className="bg-muted dark:bg-gray-800">
        <Container>
          <div className="text-center mb-8 md:mb-12 space-y-4 px-4">
            <div className="h-8 md:h-10 bg-accent dark:bg-gray-700 rounded-lg mx-auto max-w-md"></div>
            <div className="h-4 md:h-6 bg-accent dark:bg-gray-700 rounded-lg mx-auto max-w-sm"></div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[1, 2, 3].map((index) => (
              <div
                key={index}
                className="text-center p-4 md:p-6 rounded-xl bg-card dark:bg-gray-700 border border-border dark:border-gray-600"
              >
                <div className="w-12 h-12 md:w-16 md:h-16 bg-accent dark:bg-gray-600 rounded-lg mx-auto mb-3"></div>
                <div className="h-8 md:h-10 bg-accent dark:bg-gray-600 rounded-lg mb-2"></div>
                <div className="h-4 bg-accent dark:bg-gray-600 rounded-lg w-3/4 mx-auto"></div>
              </div>
            ))}
          </div>
        </Container>
